...
Then mount it in `~/.dsh/profiles/web/cordis.patch.yml` and restart dsh web — see [Installation](#installation).
...
|---|---|---|
| `paths` | `string[]` | **required** — absolute file paths (can be multiple; merged into one invocation) |
